...
Allow browser location access to see nearby sites (100 mi radius). Click a marker to open a popup with site details, then use the expand icon to open the full detail drawer. Check **Include in comparison** on 2–5 sites to show the chart.
